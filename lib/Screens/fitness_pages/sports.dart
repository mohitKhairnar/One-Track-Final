                    ...
                    children: [
                      Container(
                        ...
                        child: ListView(children: [
                          ...
                          _buildPositions(context,'running', 'Running','Good Health'),
                          _buildPositions(context,'swimming', 'Swimming','Good Health'),
                          _buildPositions(context,'cycling', 'Cycling','Good Health'),
                          _buildPositions(context,'Jogging', 'Jogging','Good Health'),
...
Widget _buildPositions(BuildContext context, String img, String sportName,String SportSubtitle) {
      ...
      child: InkWell(
          onTap: () {
            Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => SportDetailsPage(heroTag: "images/$img.jpg", sportName: sportName)
            ));
          },
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
